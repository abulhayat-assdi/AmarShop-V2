...
// `hasTestimonials` / `hasBlog` — the /testimonials and /blog links (nav +
// footer) only appear once a platform admin has published content there,
// so the site never links to an empty page (CLAUDE.md rule #8).
