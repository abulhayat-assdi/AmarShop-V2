...
export const en = {
  ...
  track: {
    ...
    intro: "Enter your order number and the phone number you used at checkout.",
    ...
    errOrderNumber: "Enter a valid order number.",
    errPhone: "Enter the phone number used on the order (e.g. 017XXXXXXXX).",
    errNotFound: "No order found with that number and phone.",
    status: {
      placed: "Order placed",
      confirmed: "Confirmed",
      ready: "Ready to ship",
