...
export const bn: Messages = {
  ...
  confirmation: {
    ...
    orderNumber: "অর্ডার নম্বর: {number}",
    trackOrder: "এই অর্ডার ট্র্যাক করুন",
  },

  track: {
    title: "আপনার অর্ডার ট্র্যাক করুন",
    intro: "আপনার অর্ডার নম্বর এবং চেকআউটে ব্যবহৃত ফোন নম্বর দিন।",
    orderNumberLabel: "অর্ডার নম্বর",
    orderNumberPlaceholder: "#0042",
    ...
    errOrderNumber: "সঠিক অর্ডার নম্বর দিন।",
    errPhone: "অর্ডারে ব্যবহৃত ফোন নম্বরটি দিন (যেমন 017XXXXXXXX)।",
    errNotFound: "এই নম্বর ও ফোন দিয়ে কোনো অর্ডার পাওয়া যায়নি।",
    status: {
